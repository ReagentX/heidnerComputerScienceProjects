...
class Robot extends Canvas
{
   ...
   public void upperBody( Graphics window )
   {
      ...
      window.setColor(Color.GRAY);
      window.fillRect(320, 340, 170, 170 );
      ...
      window.setColor(Color.BLACK);
      window.fillOval(390, 380, 20, 20);
      window.setColor(Color.BLACK);
      window.fillOval(390, 410, 20, 20);      
      window.setColor(Color.BLACK);
      window.fillOval(390, 440, 20, 20);
      window.setColor(Color.BLACK);
      window.fillOval(390, 470, 20, 20);
        //add more code here
   }
   ...
   public void lowerBody( Graphics window )
   {
      ...
      window.fillRect(400, 530, 10, 250 );
      
      window.setColor(Color.ORANGE);
      window.fillOval(340, 780, 15, 150);
